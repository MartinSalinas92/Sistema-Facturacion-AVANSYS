  ...
  =========================================================-->
        <div class="col-lg-12 col-xs-12">
          ...
          <div class="box box-success">
                ...
                <form role="form" method="post" class="formularioVentaDevoluciones">
                  ...
                  <div class="box-body"> 
                          ...
                          <!--======================================================
                              ...
                              <div class="form-group">
                                  <div class="input-group">
                                        <select class="form-control input-lg" id="idMotivo"  name="tipoMotivo" required> 
                              ...
                              <div class="form-group row nuevoProductoDevolucion">
                            ...
                            <input type="hidden" name="listarProductosD" id="listarProductosD">
                              <!--======================================================
          ...
          <div class="box-footer">
              ...
              <button type="submit" class="btn btn-primary pull-right">Realizar Devolucion</button>
                ...
                $guardarVenta = new Controladordevoluciones();
                $guardarVenta -> CrtDevoluciones();
