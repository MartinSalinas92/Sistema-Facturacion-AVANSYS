...
class modeloProductos{
  ...
  =========================================================--  */
    ...
    static public function crearProductos($tabla,$datos){
        $stmt=Conexion::conectar()->prepare("INSERT INTO $tabla (imagen,nombre,codigo,descripcion,precio_venta,precio_compra,stock,stock_min,marca_id,categoria_id) VALUES (:imagen,:nombre,:codigo,:descripcion,:precio_venta,:precio_compra,:stock,:stock_min,:marca_id,:categoria_id)");
  ...
  =========================================================--  */
    ...
    static public function editarProductos($tabla,$datos){
        $stmt=Conexion::conectar()->prepare("UPDATE $tabla SET imagen = :imagen, nombre = :nombre, descripcion = :descripcion,codigo = :codigo, precio_venta = :precio_venta, precio_compra = :precio_compra, stock = :stock, marca_id = :marca_id, categoria_id = :categoria_id WHERE id_producto = :id_producto"); 
