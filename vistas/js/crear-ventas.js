...
function editp(id,nombre,descripcion,codigo,stock,precio_venta){
 ...
 if(stock==3){
    swal({
       title:"ALERTA! su stock esta proximo a terminarse",
       type:"warning",
            ...
            '<!--  descripcion del producto-->',
          	...
          	'<div class="row" style="padding:5px 15px">'+
                  ...
                  '<div class="col-xs-3">'+
                                   ...
                                   ' <input type="number" class="form-control nuevaCantidadProducto" id="nuevaCantidadDeProducto'+idProducto+'"name="nuevaCantidadProducto[]" onchange="restarstock('+idProducto+','+stock+')" stock="'+stock+'" min="1" value=1 max="'+stock+'"  nuevoStock="'+Number(stock-1)+'">'+
                  ...
                  ' <div class="col-xs-3 ingresoPrecio" style="padding-left:0px">'+
                           ...
                           '<div class="input-group"> '+
                                 ...
                                 '<input type="text" class="form-control nuevoPrecioProducto" name="nuevoPrecioProducto[]" precioReal="'+precio_venta+'" precioRealFinal="'+precio_venta+'" id="ProductoPrecioVenta'+idProducto+'" value="'+precio_venta+'" readonly required>'+   
