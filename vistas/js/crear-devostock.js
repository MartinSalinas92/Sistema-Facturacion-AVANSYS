...
function editpdevoluciones(id,descripcion,cantidad){
    // console.log('datos');		
     ...
     $('.nuevoProductoDevolucionStock').append(
...
$('.formularioVentaDevolucionesStock').on("click","button.quitarProducto", function(){
    // console.log('button');
...
$(".formularioVentaDevolucionesStock").on("change", "input.nuevaCantidadProducto", function(){
...
function listarProductos(){
  ...
  var cantidad = $(".nuevaCantidadProducto");
    ...
    console.log('listarProductosDS',listarProductos);
	$("#listarProductosDS").val(JSON.stringify(listarProductos)); 
